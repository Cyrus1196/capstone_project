...
**More detail on FR-09 and FR-10:** see [`docs/FR-09_FR-10_Functional_Requirements.md`](docs/FR-09_FR-10_Functional_Requirements.md)
...
## Where to find FR-09 and FR-10

| Location | Path |
|----------|------|
| **Full expanded FR-09 & FR-10 (recommended)** | `c:\capstone_project\docs\FR-09_FR-10_Functional_Requirements.md` |
| **All FR-01 to FR-10 summary table** | `c:\capstone_project\docs\Functional_and_Non-functional_Requirements.md` |
| **Word document** | `c:\capstone_project\docs\Functional_and_non_functional.docx` |
| **This file (Appendix O)** | Rows **FR-09** and **FR-10** are the last two rows in section A above |
