...
const CreditEvaluationManagement = ({ approvalMode = false }) => {
  ...
  const ceTotal = visibleEvaluations.length;
  ...
  const pagedVisibleEvaluations = visibleEvaluations.slice(ceStart, ceStart + ceListPageSize);
  ...
  const creditEvalStudentOptions = useMemo(
    () =>
      (lookupData.students || []).map((student) => ({
        value: String(student.student_id),
        label: `${student.first_name || student.full_name || ''} ${student.last_name || ''} ${
  ...
  const creditEvalSchoolOptions = useMemo(
    () =>
  ...
  const creditEvalUserOptions = useMemo(
    () =>
        ...
        <table className="data-table">
          ...
          <tbody>
            {visibleEvaluations.length === 0 ? (
              ...
              pagedVisibleEvaluations.map((evaluation) => {
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleSubmit} className="modal-form">
              ...
              {approvalMode && editingItem ? (
                ...
                <>
              <div className="form-group">
                <label htmlFor="ce-modal-student">Student <span className="required">*</span></label>
                <SearchableSelect
                  id="ce-modal-student"
                  value={formData.student_id}
                  onChange={(v) => setFormData({ ...formData, student_id: v })}
                  options={creditEvalStudentOptions}
              ...
              <div className="form-group">
                <label htmlFor="ce-modal-school">School <span className="required">*</span></label>
                <SearchableSelect
                  id="ce-modal-school"
                  value={formData.school_id}
                  onChange={(v) => setFormData({ ...formData, school_id: v })}
                  options={creditEvalSchoolOptions}
              ...
              <div className="form-group">
                <label htmlFor="ce-modal-evaluator">Evaluated By <span className="required">*</span></label>
                <SearchableSelect
                  id="ce-modal-evaluator"
                  value={formData.evaluated_by}
                  onChange={(v) => setFormData({ ...formData, evaluated_by: v })}
                  options={creditEvalUserOptions}
                  emptyLabel="Select Evaluator"
