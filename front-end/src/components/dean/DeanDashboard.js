...
const DeanDashboard = ({
  ...
  if (!showEvalModules) {
    return (
      <div className="dean-dash" data-tour="page-dean-dashboard">
  ...
  return (
    <div className="dean-dash" data-tour="page-dean-dashboard">
      ...
      {loading ? (
        ...
        <>
          <div className="dean-dash__stats" data-tour="dean-stats">
          ...
          <div className="dean-dash__grid">
            <div className="dean-dash-panel">
              ...
              <div className="dean-quick-actions" data-tour="dean-quick-actions">
                <button
                  type="button"
