          ...
          <div className="student-profile-grid">
            ...
            <div className="form-group">
              ...
              <span className="student-profile-hint">
                Synced with progress-based status when evaluations are saved.
              </span>
            </div>
            ...
            {profile?.computed_academic_status ? (
              <div className="form-group student-profile-computed-status">
                <span className="student-profile-computed-label">Progress-based status (curriculum)</span>
                <div
                  className={
                ...
                <span className="student-profile-hint">
                  From your curriculum sequence and completed subjects (same logic as academic evaluation).
                </span>
              </div>
            ) : null}
          </div>
