        ...
        try {
            ...
            $transformed = $curricula->map(function($curriculum) {
                ...
                if ($curriculum->electiveSlot) {
                    $prereqSlot = $curriculum->electiveSlot->prerequisiteSlot;
                    $data['electiveSlot'] = [
                        ...
                        'prerequisite_slot_id' => $curriculum->electiveSlot->prerequisite_slot_id,
                        'prerequisiteSlot' => $prereqSlot ? [
                            'elective_slot_id' => $prereqSlot->elective_slot_id,
                            'slot_name' => $prereqSlot->slot_name,
                            'program_id' => $prereqSlot->program_id,
                        ] : null,
