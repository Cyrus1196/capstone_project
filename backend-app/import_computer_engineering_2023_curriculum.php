...
if (! $header) {
    $headerId = DB::table('tbl_curriculum_header')->insertGetId([
        ...
        'Effective_Year' => 2023,
        'description' => 'Effective SY 2023-2024; Based on CMO No. 87 Series of 2017',
    ]);
} else {
...
$subjects = [
    ...
    ['ITE 290', 'Object-Oriented Programming', 2, 2],
    ...
    ['MAT 042', 'Discrete Mathematics', 3, 3],
...
$curriculumRows = [
    ...
    ['GEN 004', 1, 2], ['ART 002', 1, 2], ['GEN 001', 1, 2], ['GEN 005', 1, 2], ['MAT 076', 1, 2], ['PHY 032', 1, 2], ['ITE 290', 1, 2], ['NST 022', 1, 2],
    ['MAT 126', 2, 1], ['CHE 025', 2, 1], ['ITE 294', 2, 1], ['ECE 069', 2, 1], ['CPE 037', 2, 1], ['PED 030', 2, 1], ['SSP 005', 2, 1], ['GEN 006', 2, 1],
    ['BES 024', 2, 2], ['ECO 017', 2, 2], ['MAT 042', 2, 2], ['MAT 120', 2, 2], ['CPE 038', 2, 2], ['CPE 039', 2, 2], ['PED 031', 2, 2], ['SSP 006', 2, 2], ['__GEC_ELECTIVE_1__', 2, 2],
    ['CPE 040', 3, 1], ['ITE 076', 3, 1], ['CPE 041', 3, 1], ['CPE 042', 3, 1], ['CPE 043', 3, 1], ['CPE 044', 3, 1], ['__PROF_ELECTIVE_1__', 3, 1], ['PED 032', 3, 1], ['SSP 007', 3, 1], ['__GEC_ELECTIVE_2__', 3, 1],
    ['CPE 045', 3, 2], ['CPE 046', 3, 2], ['CPE 047', 3, 2], ['CPE 014', 3, 2], ['__PROF_ELECTIVE_2__', 3, 2], ['PED 033', 3, 2], ['CPE 032', 3, 2], ['SSP 008', 3, 2], ['__GEC_ELECTIVE_3__', 3, 2],
    ['CPE 050', 3, 3], ['__PROF_ELECTIVE_3__', 3, 3], ['CPE 013', 3, 3],
    ['CPE 048', 4, 1], ['CPE 049', 4, 1], ['CPE 051', 4, 1], ['ECE 029', 4, 1], ['SSP 009', 4, 1], ['CPE 052', 4, 1], ['CPE 005', 4, 1],
    ['CPE 036', 4, 2], ['CPE 004', 4, 2],
];

$slotDefinitions = [
    '__GEC_ELECTIVE_1__' => ['slot_name' => 'BSCPE 2023 GEC Elective 1', 'year' => 2, 'semester' => 2, 'choices' => ['GEN 010']],
    '__GEC_ELECTIVE_2__' => ['slot_name' => 'BSCPE 2023 GEC Elective 2', 'year' => 3, 'semester' => 1, 'choices' => ['SCX 010']],
    '__GEC_ELECTIVE_3__' => ['slot_name' => 'BSCPE 2023 GEC Elective 3', 'year' => 3, 'semester' => 2, 'choices' => ['ENG 188']],
    '__PROF_ELECTIVE_1__' => ['slot_name' => 'BSCPE 2023 Professional Elective 1', 'year' => 3, 'semester' => 1, 'choices' => ['CPE 053']],
    '__PROF_ELECTIVE_2__' => ['slot_name' => 'BSCPE 2023 Professional Elective 2', 'year' => 3, 'semester' => 2, 'choices' => ['CPE 054']],
    '__PROF_ELECTIVE_3__' => ['slot_name' => 'BSCPE 2023 Professional Elective 3', 'year' => 3, 'semester' => 3, 'choices' => ['CPE 055']],
];
...
$standingPrerequisites = [
    ...
    // CPE 036 is 4th-year standing in this curriculum, but the 2018 BSCPE sheet uses 3rd-year standing.
    // Leave its subject-level rule untouched so the older curriculum does not inherit the stricter label.
