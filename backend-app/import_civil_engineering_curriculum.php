...
if (! $header) {
    $headerId = DB::table('tbl_curriculum_header')->insertGetId([
        ...
        'Effective_Year' => 2018,
        'description' => 'Effective SY 2018-2019; Construction Engineering and Management specialization; Based on CMO No. 92 Series of 2017',
    ]);
} else {
...
$subjects = [
    ...
    ['ECE 002', 'Engineering Data Analysis', 3, 3],
    ['SCX 010', 'Environmental Science', 3, 3],
    ['CPE 036', 'Technopreneurship', 3, 3],
    ['CIE 062', 'Structural Theory', 4, 4],
...
$curriculumRows = [
    ['GEN 002', 1, 1], ['GEN 003', 1, 1], ['MAT 152', 1, 1], ['HIS 007', 1, 1], ['MAT 171', 1, 1], ['CIE 110', 1, 1], ['PED 025', 1, 1], ['NST 021', 1, 1],
    ['GEN 004', 1, 2], ['ART 002', 1, 2], ['GEN 001', 1, 2], ['GEN 005', 1, 2], ['MAT 076', 1, 2], ['PHY 032', 1, 2], ['PED 026', 1, 2], ['NST 022', 1, 2],
    ['GEN 006', 2, 1], ['CIE 111', 2, 1], ['BES 043', 2, 1], ['MAT 052', 2, 1], ['BES 025', 2, 1], ['__GEC_ELECTIVE_1__', 2, 1], ['PED 027', 2, 1], ['SSP 005', 2, 1], ['CHE 025', 2, 1],
    ['BES 024', 2, 2], ['CIE 112', 2, 2], ['BES 001', 2, 2], ['BES 026', 2, 2], ['BES 047', 2, 2], ['PED 028', 2, 2], ['SSP 006', 2, 2], ['CIE 114', 2, 2], ['CIE 113', 2, 2], ['CIE 115', 2, 2],
    ['ECE 002', 3, 3], ['__GEC_ELECTIVE_2__', 3, 3],
    ['CPE 036', 3, 1], ['CIE 062', 3, 1], ['CIE 118', 3, 1], ['CIE 043', 3, 1], ['CIE 116', 3, 1], ['CIE 117', 3, 1], ['__GEC_ELECTIVE_3__', 3, 1], ['SSP 007', 3, 1],
...
$slotDefinitions = [
    '__GEC_ELECTIVE_1__' => ['slot_name' => 'BSCE GEC Elective 1', 'year' => 2, 'semester' => 1, 'choices' => ['GEN 010']],
    '__GEC_ELECTIVE_2__' => ['slot_name' => 'BSCE GEC Elective 2', 'year' => 3, 'semester' => 3, 'choices' => ['SCX 010']],
    '__GEC_ELECTIVE_3__' => ['slot_name' => 'BSCE GEC Elective 3', 'year' => 3, 'semester' => 1, 'choices' => ['ENG 188']],
];
