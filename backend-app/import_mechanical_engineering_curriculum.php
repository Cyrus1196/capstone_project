...
if (! $header) {
    $headerId = DB::table('tbl_curriculum_header')->insertGetId([
        ...
        'Effective_Year' => 2018,
        'description' => 'Effective SY 2018-2019; Based on CMO No. 97 Series of 2017',
    ]);
} else {
...
$subjects = [
    ...
    ['MAT 170', 'Advanced Mathematics for Mechanical Engineers', 3, 3],
    ...
    ['MEE 044', 'Mechanical Engineering Project Study', 1, 1],
    ...
    ['MEE 085', 'On-the-Job Training for Mechanical Engineering (240 hrs)', 2, 2],
];
...
$curriculumRows = [
    ['GEN 002', 1, 1], ['GEN 003', 1, 1], ['MAT 152', 1, 1], ['HIS 007', 1, 1], ['MAT 171', 1, 1], ['MEE 095', 1, 1], ['CHE 025', 1, 1], ['PED 025', 1, 1], ['NST 021', 1, 1],
    ['GEN 004', 1, 2], ['ART 002', 1, 2], ['GEN 001', 1, 2], ['GEN 005', 1, 2], ['MAT 076', 1, 2], ['PHY 032', 1, 2], ['PED 026', 1, 2], ['NST 022', 1, 2],
    ['PED 027', 2, 1], ['__GEC_ELECTIVE_1__', 2, 1], ['MAT 052', 2, 1], ['BES 025', 2, 1], ['BES 042', 2, 1], ['MEE 027', 2, 1], ['MEE 096', 2, 1], ['BES 024', 2, 1], ['MEE 040', 2, 1], ['ITE 297', 2, 1], ['SSP 005', 2, 1],
    ['PED 028', 2, 2], ['MEE 097', 2, 2], ['BES 062', 2, 2], ['ECE 079', 2, 2], ['MEE 029', 2, 2], ['MEE 034', 2, 2], ['BES 027', 2, 2], ['MAT 170', 2, 2], ['SSP 006', 2, 2], ['__PROF_ELECTIVE_1__', 2, 2],
    ...
    ['MEE 048', 4, 1], ['MEE 100', 4, 1], ['MEE 103', 4, 1], ['MEE 038', 4, 1], ['MEE 008', 4, 1], ['SSP 009', 4, 1], ['MEE 105', 4, 1],
    ['MEE 116', 4, 2], ['MEE 107', 4, 2], ['MEE 108', 4, 2], ['MEE 109', 4, 2], ['MEE 085', 4, 2],
];

$slotDefinitions = [
    '__GEC_ELECTIVE_1__' => ['slot_name' => 'BSME GEC Elective 1', 'year' => 2, 'semester' => 1, 'choices' => ['GEN 010']],
    '__GEC_ELECTIVE_2__' => ['slot_name' => 'BSME GEC Elective 2', 'year' => 3, 'semester' => 1, 'choices' => ['SCX 010']],
    '__GEC_ELECTIVE_3__' => ['slot_name' => 'BSME GEC Elective 3', 'year' => 3, 'semester' => 1, 'choices' => ['ENG 188']],
    '__PROF_ELECTIVE_1__' => ['slot_name' => 'BSME Professional Elective 1', 'year' => 2, 'semester' => 2, 'choices' => ['MEE 115']],
    '__PROF_ELECTIVE_2__' => ['slot_name' => 'BSME Professional Elective 2', 'year' => 3, 'semester' => 2, 'choices' => ['MEE 112']],
    '__PROF_ELECTIVE_3__' => ['slot_name' => 'BSME Professional Elective 3', 'year' => 3, 'semester' => 2, 'choices' => ['MEE 113']],
];
