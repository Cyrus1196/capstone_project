...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2026 at 01:05 PM
...
INSERT INTO `tbl_users` (`user_id`, `email`, `password`, `contact_number`, `role_id`, `status`, `failed_login_attempts`, `locked_until`, `password_changed_at`, `use_custom_permissions`, `last_login_at`) VALUES
(1, 'admin@example.com', '$2y$12$UiWggmUHq8.NoKA4YPowoOUTm2Zg3yG6.aV3FzNcNaUCKJU3lRFAK', NULL, 1, 'active', 0, NULL, '2026-03-27 09:52:17', 0, '2026-04-19 04:56:13'),
(2, 'student@example.com', '$2y$12$b1U.OcKusIbSEx8/wqS8b.yU0twkTGdExnXEKNke5Xud50obGOjw2', NULL, 3, 'active', 0, NULL, '2026-03-27 09:52:17', 0, NULL),
(8, 'student2@example.com', '$2y$12$8uzkn1jNh5aGkjj8Ht2Tzet2Z6PdvdDTcDLk6fsh5SwmZ6w8VLDQa', '09171234567', 3, 'active', 0, NULL, '2026-03-27 09:52:17', 0, NULL),
(15, 'dean@example.com', '$2y$12$N6LOLQ0RTPwIwBDmOsBOQe2Bl7BWi4MKWNR8NUEbYEbyGO7tuKGnG', NULL, 4, 'active', 6, '2026-04-19 05:01:27', '2026-03-27 09:52:17', 1, '2026-04-19 04:10:54'),
(16, 'sample.faculty@example.com', '$2y$10$ACuK7JqWcolezYhdicIvwuVBwGMwlV30BKXLX8YTnhG0Awdh1V8IC', '09170000000', 2, 'active', 0, NULL, '2026-03-27 09:52:17', 0, NULL),
(17, 'cherry@gmail.com', '$2y$12$rWMmW8CtRNFpqoxzxUILlOVuZSD4r0kPF6ZOdpBdASxm5snD8rQDS', '123456787654', 3, 'active', 0, NULL, '2026-03-27 09:52:17', 0, NULL),
(21, 'adviser@example.com', '$2y$12$fz3DfRH16I0YYAp93cKSfOzSycSVP.IvnJEWWEIi8oAYVJLxMtmTm', NULL, 6, 'active', 0, NULL, '2026-03-27 09:52:17', 0, NULL),
(22, 'faculty@example.com', '$2y$12$J1Ra086IVFipgJgNL6Xo.uXNyCeps1.zlIaH0Cwz3R1quxB3nZG8e', NULL, 2, 'active', 0, NULL, '2026-03-27 09:52:17', 0, NULL),
(30, 'cyrus@example.com', '$2y$12$xLpgRmQVqaaCzaeZG2.3u.yPSBwKfGXPbFQ4zobQ2OGtEFTnqoE9i', '09987654321', 3, 'active', 0, NULL, '2026-03-27 09:52:17', 0, NULL),
(31, 'sean@example.com', '$2y$12$FxvRU/sbO8FSRpfIHOdH4.G/AMa27cphtFVluwUoYlHTK5iJgzREy', '09665432174', 3, 'active', 0, NULL, '2026-03-27 09:52:17', 0, NULL),
(32, 'baloro@example.com', '$2y$12$dPxOhQa.rfe7r9vsJHckM.F48Bijxtc562BzjGSwrosBd4NNm/c4y', '09987654321', 3, 'active', 0, NULL, '2026-03-27 18:11:09', 0, NULL),
(33, 'jb@example.com', '$2y$12$4DRCId7uz5VXswrKn1f1seLQCiT.12K1HiZpBwFmO2Ln/S76DY.X6', '09987654321', 3, 'active', 0, NULL, '2026-03-28 00:26:25', 0, NULL),
(34, 'evaluator@example.com', '$2y$12$r3QBELje.SM4EpaogtZ4IuLK3ECNf1Zbux0o6p/Y9He2qEQYVhUm2', '09987654321', 2, 'active', 0, NULL, '2026-03-28 19:41:35', 1, NULL),
(35, 'jordan.csvimport@example.com', '$2y$12$5AILMMWQJNp8V3txRlJT/enyIWeQSJgoaJ2qiiCtvXmVW7fzc.GOO', '09171234567', 3, 'active', 0, NULL, '2026-03-31 11:48:13', 0, NULL),
(36, 'demo.new@example.com', '$2y$12$6tOH8s0Rts6BPCS8dSvu1uU.YUdrSEGOHxIQmqx3Pfu/Da4y8z43u', NULL, 3, 'active', 0, NULL, '2026-03-31 11:47:34', 0, NULL),
(37, 'it.import.morgan@example.com', '$2y$12$fE/Ls8scYW0BeaGKIE80IusX.ZvoPkGekD103zjwEYw36Hw37reK2', '09189990002', 3, 'active', 0, NULL, '2026-03-31 12:55:56', 0, NULL),
(38, 'it.3rd.irregular@example.com', '$2y$12$61j8NhzEQcPxRPJxUoNyWOWvtFGLLckNUcLVJoT8O6.TNGuhKb/Bi', '09189990003', 3, 'active', 0, NULL, '2026-04-12 19:11:10', 0, NULL),
(39, 'it.irreg.3rd.failures@example.com', '$2y$12$gYy6M/kSKcZos4cHXq2OeOPiOF2jBrRRSvV8Pcmnoojc8SFS5IoPm', '09189990077', 3, 'active', 0, NULL, '2026-04-12 19:24:24', 0, NULL);
...
--
ALTER TABLE `audit_logs`
  MODIFY `audit_logs_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=232;
...
--
ALTER TABLE `tbl_role_permissions`
  MODIFY `role_permission_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1077;
...
--
ALTER TABLE `tbl_user_permissions`
  MODIFY `user_permission_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
